...
$(function () {
    ...
    function getModal() {
        var frase = arguments.length <= 0 || arguments[0] === undefined ? "Не верно" : arguments[0];

        var $body = $('body');
        var $modal = $('<div class="modal">' + '<p class="frase">' + frase + '</p>' + '<button type="button" class="modal-button">Close</button>' + '</div>');
