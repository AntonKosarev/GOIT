...
$(function(){$('.jcarousel').jcarousel({animation:'slow'});$('.jcarousel-prev').click(function(){$('.jcarousel').jcarousel('scroll','-=1');});$('.jcarousel-next').click(function(){$('.jcarousel').jcarousel('scroll','+=1');});});$("select").selectbox();$(function(){$('.checkboxes').on('click','.check',function(){$(this).toggleClass('active');$(this).find('.check_inner_img').toggleClass('check_inner_img__active');var $input=$(this).find('input');if($input[0].checked){$input.prop('checked',false);}else{$input.prop('checked',true);}});});$(document).ready(function(){$('.dropdown').hover(function(){$(this).children('.submenu').slideDown(200);},function(){$(this).children('.submenu').slideUp(200);});});